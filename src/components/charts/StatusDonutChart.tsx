...
export function StatusDonutChart({ stats }: Props) {
  ...
  if (total === 0) {
    return <div className="flex items-center justify-center h-40 text-indigo-400 text-sm">No data</div>;
  }
      ...
      <div className="space-y-2.5">
        {segments.map(seg => (
          <div key={seg.label} className="flex items-center gap-2.5">
            ...
            <div>
              <p className="text-xs font-semibold text-indigo-700">{seg.label}</p>
